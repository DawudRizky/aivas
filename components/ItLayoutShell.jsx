...
export default function ItLayoutShell({ children }) {
  const handleMobileSidebarToggle = () => {
    window.dispatchEvent(new CustomEvent("aivas-toggle-it-mobile-sidebar"));
  };

  return (
    <div className="flex h-[100dvh] overflow-hidden bg-[#f8fafc] font-sans text-slate-800">
      <Sidebar />
